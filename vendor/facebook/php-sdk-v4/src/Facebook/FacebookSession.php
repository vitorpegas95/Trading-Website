...
class FacebookSession
{
  ...
  public function getSessionInfo($appId = null, $appSecret = null)
  {
	...
	$object2 = $object1->execute();
	$object3 = $object2->getGraphObject(GraphSessionInfo::className());
  ...
  public function getExchangeToken($appId = null, $appSecret = null)
  {
	...
	$response = $response->execute()->getGraphObject();
